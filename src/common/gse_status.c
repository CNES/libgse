...
static char *gse_status_string[STATUS_MAX + 1] =
{
  ...
  [0x0207] = "There is not enough space before data to write header",
  [0x0208] = "The specified offset are too long for the virtual buffer",
  [0x0209] = "The specified length for buffer is null",
  ...
  [0x0606] = "Packet is too small for a GSE packet",
  [0x0607 ... 0x06FF] = "Unknown status",
