...
./test_encap 4097 ./output/encap_mult_frag_dflt_length.pcap ./input/encap_mult_frag_dflt_length.pcap || ./test_encap verbose 4097 ./output/encap_mult_frag_dflt_length.pcap ./input/encap_mult_frag_dflt_length.pcap
